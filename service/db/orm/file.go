...
func OnFileUploadFinished(filehash string, filename string,
	filesize int64, fileaddr string) (res SqlResult) {
...
// 从mysql批量获取文件元信息
func GetFileMetaList(limit int64) (res SqlResult) {
	stmt, err := mydb.DBConn().Prepare(
...
// 更新文件的存储地址
func UpdateFileLocation(filehash string, fileaddr string) (res SqlResult) {
	stmt, err := mydb.DBConn().Prepare(
