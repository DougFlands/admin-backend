...
type UploadService interface {
	// 获取上传入口地址
	UploadEntry(ctx context.Context, in *ReqEntry, opts ...client.CallOption) (*Resp, error)
}
...
func (c *uploadService) UploadEntry(ctx context.Context, in *ReqEntry, opts ...client.CallOption) (*Resp, error) {
...
func (h *uploadServiceHandler) UploadEntry(ctx context.Context, in *ReqEntry, out *Resp) error {
